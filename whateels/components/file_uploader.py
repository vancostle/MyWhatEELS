...
class FileUploader(pn.Column):
    ...
    def _show_success_message(self):
        ...
        self._success_message_text.object = (
            f"""
            <p title="{self._current_filename}" style='text-align:center;margin:0;color:white;font-weight:bold;display:-webkit-box;-webkit-line-clamp:1;-webkit-box-orient:vertical;overflow:hidden;text-overflow:ellipsis;max-width:100%;'>
