...
class RosettaFileProcessorService:
    ...
    def _signal_to_dataset(self, signal: dict, file_path: str) -> xr.Dataset | None:
        ...
        try:
            ...
            self._attach_attrs(ds, meta, file_path)
            return ds
    ...
    def _attach_attrs(self, ds: xr.Dataset, meta: dict, file_path: str) -> None:
        ...
        ds.attrs['beam_energy']        = acq.get('beam_energy', None)
        ds.attrs['collection_angle']   = eels_meta.get('collection_angle', None)
        ds.attrs['convergence_angle']  = acq.get('convergence_semiangle_rad', None)
